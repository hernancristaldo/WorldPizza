export default class Tabla2 {
     ...
     */
    llenarDatos({ nameSessionStorage = null, arrayDatos, objColumnas, id_tabla, filas = 5, colorEstado = false, ordenPorDefecto = null, fuente }) {
    ...
    llenarTabla() {
        ...
        let columnasSinId = columnas.filter(col => col.nombre !== "Id");

        // Creamos las columnas titulo.
        columnasSinId.forEach(title => {

            let column = document.createElement("div");
            column.className = this.fuente === "small" ? "table-title-small" : "table-title-general";
        ...
        arrayRecortado.forEach((user, index) => {
            ...
            columnas.forEach(col => {
                ...
                if (col.nombre !== "Id") {
                    ...
                    item.className = this.fuente === "small" ? "item-small" : "item";
        ...
        cssTablaContainer.style.gridTemplateColumns = `repeat(${columnas.length - 1}, auto)`;
        ...
        cssTablaFooter.style.gridColumnEnd = `${columnas.length}`;
